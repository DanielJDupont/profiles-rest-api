...
SECRET_KEY = "django-insecure-2e(kxf-wz79^0gzc@laj1xr=1-t2*3ysf^&#semi9=_hijbexp"
...
# This list is one of two ways to add more features to our project.
# We can use the requirements.txt to add on more pip packages.
# Or we can use python manage.py startapp to create a new app then register it here.
INSTALLED_APPS = [
